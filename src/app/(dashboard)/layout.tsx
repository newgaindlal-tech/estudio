...
export default function DashboardLayout({
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col md:flex-row">
      {/* DESKTOP SIDEBAR (Static sticky flex item - zero overlap guarantee) */}
      <aside className="hidden md:flex flex-col w-64 min-h-screen border-r border-slate-800/80 bg-slate-900/60 backdrop-blur-xl p-5 shrink-0 sticky top-0 h-screen z-30">
        {/* Brand Header */}
      ...
      {/* MAIN CONTENT REGION (Takes remaining width naturally) */}
      <main className="flex-1 min-w-0 overflow-y-auto pb-24 md:pb-8 pt-4 md:pt-6 px-4 sm:px-6 lg:px-8">
